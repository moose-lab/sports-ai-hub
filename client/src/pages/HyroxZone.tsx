 ...
 * A tools-first sport-scenario page, not a race-introduction page: persona
 * entries jump straight into the audience-filtered directory; the Season 9
 * calendar is framed as data drops. Recreated from the HYROX Zone design
 * handoff; content lives in @/data/hyrox-zone.
 *
